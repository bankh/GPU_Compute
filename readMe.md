...
{ToDo: Add a pipeline to reflect the workflow for these platforms}
...
**GPUs:**  
  ...
  [AMD Inception MI25 (16GB each)](https://github.com/bankh/GPU_Compute/blob/main/AMD/AMDGPU-pyfancontrol/readMe.md)   
...
**b - Multi GPUs**  
References:  
- [IOMMU Advisory for Multi-GPU Environments](https://community.amd.com/t5/knowledge-base/iommu-advisory-for-multi-gpu-environments/ta-p/477468)
